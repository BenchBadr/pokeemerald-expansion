...
//names
const u8 gText_SideQuestName_1[] = _("1. Help a scientist");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("A scientist is making a study about \nwild Pokémon in Arr.2. Help him make a \nlist!");
...
//map
const u8 gText_SideQuestMap1[] = _("Arr. 2, Wild Zone");
