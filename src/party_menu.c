...
static const u8 sText_TakingOut[] = _("will now walk with you!{PAUSE_UNTIL_PRESS}");
static const u8 sText_TakingIn[] = _("{STR_VAR_1} is back in his Poké Ball.{PAUSE_UNTIL_PRESS}");
