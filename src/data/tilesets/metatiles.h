...
const u16 gMetatiles_Roofs[] = INCBIN_U16("data/tilesets/secondary/roofs/metatiles.bin");
const u16 gMetatileAttributes_Roofs[] = INCBIN_U16("data/tilesets/secondary/roofs/metatile_attributes.bin");
