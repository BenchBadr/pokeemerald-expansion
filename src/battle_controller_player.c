...
static void HandleInputChooseAction(enum BattlerId battler)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        switch (gActionSelectionCursor[battler]) // POSITION CURSEUR
        {
        case 0: // Top left
...
void MoveSelectionCreateCursorAt(u8 cursorPosition, u8 baseTileNum)
{
    ...
    CopyToBgTilemapBufferRect_ChangePalette(0, src, 10 * (cursorPosition & 1) + 1, 55 + (cursorPosition & 2), 1, 2, 0x11);
...
void ActionSelectionCreateCursorAt(u8 cursorPosition, u8 baseTileNum)
{
    ...
    CopyToBgTilemapBufferRect_ChangePalette(0, src, 8 * (cursorPosition & 1) + 7, 35 + 1 * (cursorPosition & 2), 1, 2, 0x11);
    CopyBgTilemapBufferToVram(0);
}

void ActionSelectionDestroyCursorAt(u8 cursorPosition)// position
{
    u16 src[2];
    src[0] = 0x20;
    src[1] = 0x20;
...
static void PlayerHandleChooseAction(enum BattlerId battler)
{
    ...
    ActionSelectionCreateCursorAt(gActionSelectionCursor[battler], 0); // •VOIR ICI
