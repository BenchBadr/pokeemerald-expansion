...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Check the maps application"),
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("Check Pokémon information."),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Open the settings."),
